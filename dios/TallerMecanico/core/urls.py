...
from .views import index, galeria, buscador, categoria1, chevrolet, ford, inicio_sesion, mazda, mecanico, raptor, registrar, solicitud, modificar_autos, agregar_autos, listar_autos, eliminar_auto
